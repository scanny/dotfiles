--------------------------------------------------------------------------------------
-- use Copilot chat within Neovim
...
return {
  {
    ...
    keys = {
      { "<leader>oc", ":CopilotChat<CR>", mode="n", desc = "Open Copilot Chat" },
      { "<leader>ad", ":CopilotChatDocs<CR>", mode = "v", desc = "Generate docs for selected" },
      { "<leader>ae", ":CopilotChatExplain<CR>", mode = "v", desc = "Explain selected code" },
      { "<leader>at", ":CopilotChatTests<CR>", mode = "v", desc = "Generate tests for selected" },
    },
    opts = {
